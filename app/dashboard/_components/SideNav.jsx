...
function SideNav() {
  ...
  return (
    <div className='h-screen shadow-md border bg-slate-950'>
        <div className='p-5'>
        ...
        <div className='fixed bottom-7 p-6 w-64 '>
            <Button className="w-full bg-blue-500 hover:bg-green-400 font-bold hover:text-black rounded-full transition-all duration-300 hover:scale-110">+ Create Form</Button>
            <div className='my-7'>
